...
} from "@/components/common/SearchBarGlobal";
    ...
    <View style={[styles.hero, { paddingHorizontal: horizontalPadding }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>
          Intercambia lo que quieras con quien quieras
        </Text>
        <Text style={styles.description}>
          Desde tecnología y ropa hasta hobbies y más. El punto de encuentro
          estudiantil para darle vuelta a lo que tienes sin gastar de más.
        </Text>
