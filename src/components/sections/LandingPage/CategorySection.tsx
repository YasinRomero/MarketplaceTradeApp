...
const categories: CategorySectionItem[] = [
  {
    ...
    description:
      "Herramientas de cómputo y cálculo para alto rendimiento académico.",
  ...
  },
  {
    ...
    description:
      "Instrumental clínico y de protección verificado para prácticas y clínicas.",
    badges: ["Category", "Category", "Category", "Category"],
    tone: "green",
      ...
      <View style={styles.inner}>
        <View style={styles.titleSection}>
          ...
          <Text style={styles.description}>
            Encuentra exactamente los materiales específicos que demanda tu
            carrera sin intermediarios ni cobros sorpresa.
          </Text>
        </View>
          ...
          <View style={styles.bento}>
            <View style={styles.topRow}>
              {topCategories.map((category) =>
                renderCategory(category, styles.topCard),
              )}
            </View>
