...
export function Footer({ onLoginPress, onCategoryPress, onHelpPress, onSocialPress }: FooterProps) {
	...
	return (
		<View style={styles.footer}>
			<View style={[styles.container, isCompact && styles.containerCompact, isNarrow && styles.containerNarrow]}>
				<View style={[styles.information, isCompact && styles.columnCompact]}>
					...
					<Text style={styles.description}>
						Plataforma oficial de comercio e intercambio estudiantil verificado para optimizar los recursos
				...
				<FooterSection title="Categorías" compact={isCompact}>
					{categories.map((category) => (
						<FooterLink key={category} onPress={() => onCategoryPress?.(category)}>
							{category}
						</FooterLink>
					))}
				</FooterSection>
				...
				<View style={[styles.loginSection, isCompact && styles.columnCompact]}>
					...
					<Text style={styles.description}>
						Inicia sesión para gestionar tus publicaciones, intercambios y mensajes.
					</Text>
					<Pressable
